/************************************************************************************//**
* \file         Demo/ARMCM0_STM32G0_Nucleo_G0B1RE_CubeIDE/Prog/App/boot.c
* \brief        Demo program bootloader interface source file.
* \ingroup      Prog_ARMCM0_STM32G0_Nucleo_G0B1RE_CubeIDE
* \internal
*----------------------------------------------------------------------------------------
*                          C O P Y R I G H T
*----------------------------------------------------------------------------------------
                                       ...
                                       unsigned char *tseg1, unsigned char *tseg2)
{
  ...
  /* determine the CAN peripheral clock frequency in kHz. function SystemClock_Config()
   * of this demo program set PCLK as the source clock for the CAN peripheral.
   */
  canClockFreqkHz = HAL_RCC_GetPCLK1Freq() / 1000u;
  /* the CAN peripheral clock should not be higher than 48 MHz. so only continue if
   * this is the case. with PCLK as the source clock, you can increase the APB prescaler
   * to lower the PCLK frequence. a multiple of 8 MHz for the CAN peripheral clock gives
   * the best support for most commonly CAN baudrates.
   */
