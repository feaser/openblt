/************************************************************************************//**
* \file         Demo/ARMCM0_STM32C0_Nucleo_C031C6_Keil/Boot/main.c
...
#include "stm32c0xx_ll_system.h"                 /* STM32 LL SYSTEM header             */
#include "stm32c0xx_ll_utils.h"                  /* STM32 LL UTILS header              */
...
static void SystemClock_Config(void)
{
   ...
   * the HSE cannot be configured, resulting in LL_RCC_HSE_IsReady() failing.
   */
  LL_RCC_DeInit();
