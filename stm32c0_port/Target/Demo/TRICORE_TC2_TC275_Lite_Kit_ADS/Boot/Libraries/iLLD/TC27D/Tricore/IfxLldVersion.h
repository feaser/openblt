...
#define IFX_LLD_VERSION_MINOR            16   /**< \brief Informs about new additions to the library */
#define IFX_LLD_VERSION_REVISION          1   /**< \brief Informs about patches and/or documentation changes */
