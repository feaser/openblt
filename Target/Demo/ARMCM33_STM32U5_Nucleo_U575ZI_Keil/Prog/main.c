/************************************************************************************//**
* \file         Demo/ARMCM33_STM32U5_Nucleo_U575ZI_Keil/Prog/main.c
* \brief        Demo program application source file.
* \ingroup      Prog_ARMCM33_STM32U5_Nucleo_U575ZI_Keil
* \internal
*----------------------------------------------------------------------------------------
*                          C O P Y R I G H T
*----------------------------------------------------------------------------------------
...
static void SystemClock_Config(void)
{
  ...
  {
    /* Regulator voltage scaling configuration incorrect or hardware failure. Hang the 
  ...
  /* Configure PCLK2 as the clock source for the USART peripheral. */
  ...
  /* Configure PLL as the clock source for the FDCAN peripheral. */
...
static void SystemPower_Config(void)
{
  ...
  {
    /* Regulator configuration incorrect or hardware failure. Hang the system to prevent
     * damage.
     */
    while(1);
  }
