...
__Vectors       DCD     __initial_sp               ; Top of Stack
                ...
                DCD     EthWakeUp_IRQHandler       ; Ethernet Wakeup
                DCD     CAN2_TX_IRQHandler         ; CAN2 TX
                DCD     CAN2_RX0_IRQHandler        ; CAN2 RX0
                DCD     CAN2_RX1_IRQHandler        ; CAN2 RX1
                DCD     CAN2_SCE_IRQHandler        ; CAN2 SCE
                DCD     USB_OTG_FS_IRQHandler      ; USB OTG FS
...
Reset_Handler    PROC
     ...
     IMPORT  __main
     IMPORT  SystemInit
		         ; Initialize stackpointer explicitely, because this program is
				 ; not started by a reset, but by OpenBLT
		         LDR	 R0, =__initial_sp
				 MOV	 SP, R0
                 LDR     R0, =SystemInit
                 BLX     R0
...
Default_Handler PROC
                ...
                EXPORT  USB_OTG_FS_IRQHandler      [WEAK]
