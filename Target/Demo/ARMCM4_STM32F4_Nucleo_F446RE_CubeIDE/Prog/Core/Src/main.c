...
void MX_TIM7_Init(void)
{
  ...
  /* Note that this function is generated but not actually used. TbxMbPortTimerCount()
   * handles the TIM initialization.
   */
...
void MX_USART1_UART_Init(void)
{
  ...
  /* Note that this function is generated but not actually used. TbxMbPortUartInit()
   * handles the USART initialization.
   */
