/************************************************************************************//**
* \file         Demo/ARMCM7_STM32F7_Nucleo_F746ZG_TrueStudio/Boot/main.c
* \brief        Bootloader application source file.
* \ingroup      Boot_ARMCM7_STM32F7_Nucleo_F746ZG_TrueStudio
* \internal
*----------------------------------------------------------------------------------------
*                          C O P Y R I G H T
*----------------------------------------------------------------------------------------
...
#include "stm32f7xx_ll_pwr.h"                    /* STM32 LL PWR header                */
#include "stm32f7xx_ll_rcc.h"                    /* STM32 LL RCC header                */
#include "stm32f7xx_ll_bus.h"                    /* STM32 LL BUS header                */
#include "stm32f7xx_ll_system.h"                 /* STM32 LL SYSTEM header             */
#include "stm32f7xx_ll_utils.h"                  /* STM32 LL UTILS header              */
