/************************************************************************************//**
* \file         Demo/ARMCM33_STM32H5_Nucleo_H563ZI_Keil/Prog/boot.c
* \brief        Demo program bootloader interface source file.
* \ingroup      Prog_ARMCM33_STM32H5_Nucleo_H563ZI_Keil
* \internal
*----------------------------------------------------------------------------------------
*                          C O P Y R I G H T
*----------------------------------------------------------------------------------------
                                       ...
                                       unsigned char *tseg1, unsigned char *tseg2)
{
  ...
  /* set the clock source for the CAN peripheral */
  __HAL_RCC_FDCAN_CONFIG(RCC_FDCANCLKSOURCE_HSE);
  /* obtain the CAN peripheral clock frequency in kHz. */
  canClockFreqkHz = HAL_RCCEx_GetPeriphCLKFreq(RCC_PERIPHCLK_FDCAN) / 1000u;
