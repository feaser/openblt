...
**
**     Revisions:
**     - rev. 1.0 Taru Shree 07-Apr-21  Initial release based on 
**                                      S32K1xx RM Rev 13.
**    
**     - rev. 1.1 Taru Shree 18-Feb-22  1)Initial release based on 
**                                      S32K1xx RM Rev 14.
**                                      2)DMA- 
...
#define IP_ADC_BASE_ADDRS                        { IP_ADC0_BASE }
/** Array initializer of ADC peripheral base pointers */
#define IP_ADC_BASE_PTRS                         { IP_ADC0 }
...
#define DMA_DCHPRI_CHPRI_WIDTH                   (2U)
...
#define DMA_TCD_CITER_ELINKYES_LINKCH_WIDTH      (2U)
...
#define DMA_TCD_CSR_MAJORLINKCH_WIDTH            (2U)
...
#define DMA_TCD_BITER_ELINKYES_LINKCH_WIDTH      (2U)
...
#define FLEXCAN_INSTANCE_COUNT                   (1u)
...
#define IP_FLEXCAN_BASE_ADDRS                    { IP_FLEXCAN0_BASE }
/** Array initializer of FLEXCAN peripheral base pointers */
#define IP_FLEXCAN_BASE_PTRS                     { IP_FLEXCAN0 }
...
#define IP_FTM_BASE_PTRS                         { IP_FTM0, IP_FTM1 }
...
#define IP_LPSPI_BASE_ADDRS                      { IP_LPSPI0_BASE, IP_LPSPI1_BASE }
/** Array initializer of LPSPI peripheral base pointers */
#define IP_LPSPI_BASE_PTRS                       { IP_LPSPI0, IP_LPSPI1 }
...
#define IP_LPUART_BASE_ADDRS                     { IP_LPUART0_BASE, IP_LPUART1_BASE }
/** Array initializer of LPUART peripheral base pointers */
#define IP_LPUART_BASE_PTRS                      { IP_LPUART0, IP_LPUART1 }
...
typedef struct {
  ...
  struct {                                         /* offset: 0x10, array step: 0x8 */
    __I  uint32_t EAR;                               /**< Error Address Register, slave port 0..Error Address Register, slave port 1, array offset: 0x10, array step: 0x8 */
    __I  uint32_t EDR;                               /**< Error Detail Register, slave port 0..Error Detail Register, slave port 1, array offset: 0x14, array step: 0x8 */
...
/*! @name EAR - Error Address Register, slave port 0..Error Address Register, slave port 1 */
/*! @{ */
...
/*! @name EDR - Error Detail Register, slave port 0..Error Detail Register, slave port 1 */
/*! @{ */
