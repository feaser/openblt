/************************************************************************************//**
* \file         Demo/ARMCM7_STM32H7_Nucleo_H743ZI_TrueStudio/Prog/boot.c
* \brief        Demo program bootloader interface source file.
* \ingroup      Prog_ARMCM7_STM32H7_Nucleo_H743ZI_TrueStudio
* \internal
*----------------------------------------------------------------------------------------
*                          C O P Y R I G H T
*----------------------------------------------------------------------------------------
...
static void BootComCanCheckActivationRequest(void)
{
  ...
  if (HAL_FDCAN_IsRxBufferMessageAvailable(&canHandle, FDCAN_RX_BUFFER0) > 0)
  {
    ...
    rxStatus = HAL_FDCAN_GetRxMessage(&canHandle, FDCAN_RX_BUFFER0, &rxMsgHeader,
                                      rxMsgData);
  }
