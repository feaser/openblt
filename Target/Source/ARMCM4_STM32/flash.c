...
****************************************************************************************/
/* layout of the physical flash memory */
...
/* the STM32F4x Standard Peripheral Library driver needs a sector mask instead of the
 * sector number. this ROM lookup table can quickly convert the sector number to its
 * mask.
 */
