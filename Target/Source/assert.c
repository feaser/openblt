/****************************************************************************************
|  Description: bootloader assertion module source file
|    File Name: assert.c
|
|----------------------------------------------------------------------------------------
|                          C O P Y R I G H T
...
/****************************************************************************************
** NAME:           AssertFailure
** PARAMETER:      file name of the source file where the assertion occurred.
**                 line linenumber in the source file where the assertion occurred. 
** RETURN VALUE:   none
