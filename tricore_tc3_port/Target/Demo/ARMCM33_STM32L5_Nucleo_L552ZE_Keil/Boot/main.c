/************************************************************************************//**
* \file         Demo/ARMCM33_STM32L5_Nucleo_L552ZE_Keil/Boot/main.c
...
#include "stm32l5xx_ll_pwr.h"                    /* STM32 LL PWR header                */
#include "stm32l5xx_ll_rcc.h"                    /* STM32 LL RCC header                */
#include "stm32l5xx_ll_bus.h"                    /* STM32 LL BUS header                */
#include "stm32l5xx_ll_system.h"                 /* STM32 LL SYSTEM header             */
#include "stm32l5xx_ll_utils.h"                  /* STM32 LL UTILS header              */
...
void HAL_MspInit(void)
{
  ...
  /* USB clock enable. */
  LL_PWR_EnableVddUSB();
  LL_APB1_GRP2_EnableClock(LL_APB1_GRP2_PERIPH_USB);
#endif
} /*** end of HAL_MspInit ***/
...
#if (BOOT_COM_USB_ENABLE > 0)
  /* USB clock disable. */
  LL_APB1_GRP2_DisableClock(LL_APB1_GRP2_PERIPH_USB);
