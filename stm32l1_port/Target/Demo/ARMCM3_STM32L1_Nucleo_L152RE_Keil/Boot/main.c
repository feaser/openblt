/************************************************************************************//**
* \file         Demo/ARMCM3_STM32L1_Nucleo_L152RE_Keil/Boot/main.c
...
#include "stm32l1xx_ll_pwr.h"                    /* STM32 LL PWR header                */
#include "stm32l1xx_ll_system.h"                 /* STM32 LL SYSTEM header             */
#include "stm32l1xx_ll_utils.h"                  /* STM32 LL UTILS header              */
...
static void SystemClock_Config(void)
{
  ...
  /* Configure clock prescalers and set the PLL as the main clock source. */
