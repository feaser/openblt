 ...
 *
 * Description:
 *  VCI device interface version 2.
 ****************************************************************************/
#undef  INTERFACE
#define INTERFACE  IVciDevice2
DECLARE_INTERFACE_(IVciDevice2, IVciDevice)
{
  //~~~ IUnknown methods ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  STDMETHOD(QueryInterface)(THIS_ IN REFIID riid, OUT PVOID *ppv)    PURE;
  STDMETHOD_(ULONG,AddRef )(THIS)                                    PURE;
  ...
  STDMETHOD(GetDeviceInfoExA)(THIS_ OUT PVCIDEVINFOEXA pInfo)        PURE;
  STDMETHOD(GetDeviceInfoExW)(THIS_ OUT PVCIDEVINFOEXW pInfo)        PURE;
  STDMETHOD(GetAdapterInfoA )(THIS_ OUT PVCIDEVIFINFOA pInfo)        PURE;
  STDMETHOD(GetAdapterInfoW )(THIS_ OUT PVCIDEVIFINFOW pInfo)        PURE;
  STDMETHOD(GetRuntimeInfo  )(THIS_ OUT PVCIDEVRTINFO pInfo)         PURE;
};
#undef INTERFACE

typedef IVciDevice2* PVCIDEVICE2;

/*****************************************************************************
 * Interface ID of IVciDevice2 {CDC08670-C314-4CA1-BA6A-51016BB7C23A}
 ****************************************************************************/
DEFINE_GUID(IID_IVciDevice2,
       0xCDC08670,0xC314,0x4CA1,0xBA,0x6A,0x51,0x01,0x6B,0xB7,0xC2,0x3A);
